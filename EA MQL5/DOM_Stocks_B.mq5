...
int OnInit()
  {
   ...
   g_outfile     = DailyPath("stocks_b", "dom_stocks_b");
   ...
   Print("[STOCKS_B] Started | ", ok, " symbols | flush=", FLUSH_MS, "ms | file=", g_outfile);
...
bool OpenFile()
  {
   ...
   if(g_outfile == "") g_outfile = DailyPath("stocks_b", "dom_stocks_b");
